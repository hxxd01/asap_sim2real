...
def read_conf(config_file):
    ...
    cfg.init_base_pos = np.array(config.get("init_base_pos", [0, 0, 0.97]), dtype=np.float32)
    cfg.init_base_quat_wxyz = np.array(config.get("init_base_quat_wxyz", [0.0, 0.0, 0.0, 1.0]), dtype=np.float32)
