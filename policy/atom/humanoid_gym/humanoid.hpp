...
public:
    HumanoidModel(): memoryInfo(Ort::MemoryInfo::CreateCpu(OrtArenaAllocator, OrtMemTypeDefault)){
    ...
    vector_t compute_observation(const ModelParams& params, const RobotState<double>& robot_state, const Control& control, Observations& obs){
        ...
        step_contact_targets(params, 0.8);
        ...
        proprioObs <<  
                    ...
                    command.head(3).array() * params.commands_scale.array(),
